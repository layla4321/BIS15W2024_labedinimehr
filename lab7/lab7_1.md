...
msleep %>%
  group_by(order) %>% 
  summarize(min_brain_wt = min(brainwt),
            max_brain_wt = max(brainwt),
...
```
## # A tibble: 19 × 5
##    order           min_brain_wt max_brain_wt mean_brain_wt total
##    <chr>                  <dbl>        <dbl>         <dbl> <int>
##  1 Afrosoricida         0.0026        0.0026      0.0026       1
##  2 Artiodactyla        NA            NA          NA            6
##  3 Carnivora           NA            NA          NA           12
##  4 Cetacea             NA            NA          NA            3
##  5 Chiroptera           0.00025       0.0003      0.000275     2
##  6 Cingulata            0.0108        0.081       0.0459       2
##  7 Didelphimorphia     NA            NA          NA            2
##  8 Diprotodontia       NA            NA          NA            2
##  9 Erinaceomorpha       0.0024        0.0035      0.00295      2
## 10 Hyracoidea           0.0123        0.021       0.0152       3
## 11 Lagomorpha           0.0121        0.0121      0.0121       1
## 12 Monotremata          0.025         0.025       0.025        1
## 13 Perissodactyla       0.169         0.655       0.414        3
## 14 Pilosa              NA            NA          NA            1
## 15 Primates            NA            NA          NA           12
## 16 Proboscidea          4.60          5.71        5.16         2
## 17 Rodentia            NA            NA          NA           22
## 18 Scandentia           0.0025        0.0025      0.0025       1
## 19 Soricomorpha         0.00014       0.0012      0.000592     5
```
...
```r
  #summarize(mean_brain_weight=(brainwt, na.rm =T))
```
