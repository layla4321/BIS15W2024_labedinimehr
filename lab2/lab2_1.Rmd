...
You will have to calculate it in a different way. This means that NAs will will not be calculated with integers normally. So you will have to remove the NA's. 
